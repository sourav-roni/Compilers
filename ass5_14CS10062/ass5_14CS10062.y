...
unary_operator	:		AMPERSAND {$$ = unary_address_op;printf("unary_operator-> AMPERSAND\n");}|
				MULTIPLICATION {$$ = unary_star_op;printf("unary_operator-> MULTIPLICATION\n");}|
...
unary_expression:		postfix_expression     
				...
				PLUS_PLUS unary_expression 
	  	                   ...
	  	                   char *res = strdup(($2.location)->name);
				...
				unary_operator cast_expression 
                                {
	  	                        ...
	  	                        $$.type = $2.type;
                                   ...
                                   {
                                        $$.location = new row_of_symbol_table();
                                        string s(($2.location)->name);
                                        s = "*" + s;
                                        ($$.location)->name = convert2char_star(s);
                                         $$.type = ($2.type)->next;
                                         $$.loc_temp = 0;
                                         $$.array = $2.array;                                  
...
constant :			INTEGER_CONSTANT  //done
                                {
